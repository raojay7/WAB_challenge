...
pred_img = get_pred_img(metric_net_b5a, '../../bbox_sub/myspace/test_img_bbox_16.json', '../myspace/output/ensemble/pred_img_test_b5a.json', 'feat_b5a')
pred_vid = get_pred_vid(metric_net_b5a, '../../bbox_sub/myspace/test_img_bbox_16.json', '../myspace/output/ensemble/pred_vid_test_b5a.json', 'feat_b5a')
...
def get_score(pred_img_df, pred_vid_df, s1, s2):
    ...
    for item_id, _df in tqdm(gallary_grouped):
        ...
        label = retrieved_df['category_id'].values[max_score_img_idx]
        # get distance score
...
time_end=time.time()
print('retrieval cost time {}/s',time_end-time_start)
