...
class Config:
    def __init__(self):
        ...
        self.SCALE = 'SM'
        self.OUTPUT_PATH = '/metric_sub/myspace/output/arcface_deit'
        ...
        self.BACKBONE = 'vit_deit_small_distilled_patch16_224'
        self.NET_TYPE = 'vit_224'
        self.COS_LAYER = True
        self.M = 0.30
        self.FEAT_DIM = 512
...
def main(cfg):
    ...
    net = Vit(num_classes=cfg.N_ID, feat_dim=cfg.FEAT_DIM, cos_layer=cfg.COS_LAYER,
...
if __name__ == "__main__":
    ...
    cfg = Config()
    cfg.PRETRAINED_FILE = '/metric_sub/pretrained/pretrained_deit.pt'
    main(cfg)
