...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='/data/clothes_retrieval.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/root/yolo_master/runs/train/exp20/weights/best.pt', help='model.pt path(s)')
