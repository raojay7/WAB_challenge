...
def get_dicts_train_all_img():
    result = get_dicts('/tctrain/train_dataset_part1', 'image') + \
          get_dicts('/tctrain/train_dataset_part2', 'image') + \
          get_dicts('/tctrain/train_dataset_part3', 'image') + \
          get_dicts('/tctrain/train_dataset_part4', 'image') + \
          get_dicts('/tctrain/train_dataset_part5', 'image') + \
          get_dicts('/tctrain/train_dataset_part6', 'image') + \
          get_dicts('/tctrain/train_dataset_part7', 'image') + \
          get_dicts('/tctrain/train_dataset_part8', 'image') + \
          get_dicts('/tctrain/train_dataset_part9', 'image') + \
          get_dicts('/tctrain/train_dataset_part10', 'image')

    return result

def get_dicts_train_all_vid():
    result = get_dicts('/tctrain/train_dataset_part1', 'video') + \
              get_dicts('/tctrain/train_dataset_part2', 'video') + \
              get_dicts('/tctrain/train_dataset_part3', 'video') + \
              get_dicts('/tctrain/train_dataset_part4', 'video') + \
              get_dicts('/tctrain/train_dataset_part5', 'video') + \
              get_dicts('/tctrain/train_dataset_part6', 'video') + \
              get_dicts('/tctrain/train_dataset_part7', 'video') + \
              get_dicts('/tctrain/train_dataset_part8', 'video') + \
              get_dicts('/tctrain/train_dataset_part9', 'video') + \
              get_dicts('/tctrain/train_dataset_part10', 'video')
    return result
...
def main():
    ...
    if not os.path.exists('/metric_sub/myspace'):
        os.makedirs('/metric_sub/myspace')
    create_folder('/metric_sub/myspace/input')

    with open('/metric_sub/myspace/input/taobao_train_img_metric.json', 'w') as f:
        json.dump(taobao_train_img, f)

    with open('/metric_sub/myspace/input/taobao_val_img_metric.json', 'w') as f:
        json.dump(taobao_val_img, f)

    with open('/metric_sub/myspace/input/taobao_train_vid_metric.json', 'w') as f:
        json.dump(taobao_train_vid, f)

    with open('/metric_sub/myspace/input/taobao_val_vid_metric.json', 'w') as f:
    ...
    with open('/metric_sub/myspace/input/taobao_round1_img_inst_80.json', 'w') as f:
        json.dump(train_img_inst, f)

    with open('/metric_sub/myspace/input/taobao_round1_vid_inst_80.json', 'w') as f:
    ...
    instance_encoder.to_feather('/metric_sub/myspace/input/taobao_round1_instance_encoder_80.feather')
    ...
    with open('/metric_sub/myspace/input/taobao_round2_img_inst_80.json', 'w') as f:
        json.dump(val_img_inst, f)
        
    with open('/metric_sub/myspace/input/taobao_round2_vid_inst_80.json', 'w') as f:
    ...
    with open('/metric_sub/myspace/input/taobao_round2_img_inst_80_id3000.json', 'w') as f:
        json.dump(img_sub_df.to_dict('records'), f)

    with open('/metric_sub/myspace/input/taobao_round2_vid_inst_80_id3000.json', 'w') as f:
