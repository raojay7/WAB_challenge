...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    save_dir, epochs, batch_size, weights, single_cls, evolve, data, cfg, resume, notest, nosave, workers,output_model = \
        opt.save_dir, opt.epochs, opt.batch_size, opt.weights, opt.single_cls, opt.evolve, opt.data, opt.cfg, \
        opt.resume, opt.notest, opt.nosave, opt.workers,opt.output_model_dir
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='/yolo_master/models/weights/yolov5m.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/yolo_master/models/yolov5m.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/yolo_master/data/clothes_retrieval.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='/yolo_master/data/hyp.scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--output_model_dir', default='', help='output dir for model')
